...
public class Turno implements Serializable {
    ...
    public Turno(int id_turno, Date fecha_turno, String hora_turno, String adeccion) {
        this.id_turno = id_turno;
        this.fecha_turno = fecha_turno;
        this.hora_turno = hora_turno;
        this.adeccion = adeccion;
    }
    ...
    public String getAdeccion() {
        return adeccion;
    }

    public void setAdeccion(String adeccion) {
        this.adeccion = adeccion;
    }
